...
<main className="grid min-h-screen place-items-center bg-[#f5f3e7] p-6 text-primary-900">
...
>
<div>
<p className="text-xs uppercase tracking-[0.2em] text-primary-600">Acceso seguro</p>
<h1 className="mt-1 text-4xl font-semibold leading-tight text-primary-900">Login</h1>
<p className="mt-2 text-sm text-primary-700/70">Ingresa con tus credenciales para acceder al control center.</p>
</div>

<label className="grid gap-1.5 text-sm font-medium text-primary-900">
Correo
...
<input
	...
	className="w-full rounded-xl border bg-white px-9 py-2.5 text-primary-900 outline-none focus:ring-2"
...
<label className="grid gap-1.5 text-sm font-medium text-primary-900">
	...
	<div className="relative">
		...
		<input
			...
			onChange={onChange}
			placeholder="********"
			className="w-full rounded-xl border bg-white px-9 py-2.5 text-primary-900 outline-none focus:ring-2 pr-10"
			style={{ borderColor: '#0e544b', '--tw-ring-color': '#0e544b' }}
		/>
		<button
			type="button"
...
<p className="m-0 text-center text-sm text-primary-700/70">
  ¿No tienes cuenta?{" "}
  <Link
    to="/register"
