...
export default function Reports() {
	return (
		<div className="min-h-screen flex flex-col items-center justify-center">
			<div className="w-full max-w-5xl mb-10 rounded-[2rem] bg-white border border-[var(--border)] px-10 py-7 flex flex-col md:flex-row md:items-center md:justify-between shadow-sm">
				<div>
